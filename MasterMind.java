...
class MasterMind {
    int tries, temp1, temp2, temp3, temp4, temp5, temp6;
    ...
    MasterMind() {
        ...
        temp4 = (int) (Math.random() * 10);
        temp5 = (int) (Math.random() * 10);
        temp6 = (int) (Math.random() * 10);
        number = "";
    }
    ...
    void rules() {
        ...
        System.out.println(
                "The numbers are : " + temp1 + "," + temp2 + "," + temp3 + "," + temp4 + "," + temp5 + "," + temp6);
    }
    ...
    void play() {
        try {
            ...
            java.lang.String number = read.nextLine();
    ...
    int correctNumbers(int a, int b, int c, int d) {
        java.lang.String seq = java.lang.String.valueOf(a) + java.lang.String.valueOf(b) + java.lang.String.valueOf(c)
