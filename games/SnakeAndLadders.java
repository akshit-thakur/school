 ...
 * v1.0 Started 03-05-2015
   To do:- Show proper board,include single player mode **Will do later** too and case-centric InputMismatchException handling 
...
* v1.0.1 Update includes snake at 99...no snake makes you climb(improved min and max values for random)
* v1.0.2 Update includes board show after every move.
* v1.1.0 to include 2-4 player input.
* v1.2.0 to include 1 player input.
*/
import java.util.*;
class SnakeAndLadders{
    int i,num,count1,count2,move; String p1,p2;
    Scanner read=new Scanner(System.in);
    SnakeAndLadders(){
        i=0;        num=0;        count1=0;        count2=0;            move=0;        p1="";        p2="";
    }
    public static void main(String args[]){
        SnakeAndLadders call=new SnakeAndLadders();
        call.starter();
    }
    void starter(){        
        try{
            rules();
            System.out.println("Enter your name,Player 1:");            p1=read.nextLine();
            System.out.println("Enter your name,Player 2:");            p2=read.nextLine();            
            showBoard();            playGame();
        }
    ...
    void rules(){
        ...
        System.out.println("If a snake puts you on a ladder position, you can't climb the ladder. Similarly, if a ladder takes you to snake,sanke won't bite you!");
    }
    void showBoard(){ 
        i=100;        
        for(;i>90;i--){           
            if(i==100)            System.out.print(i+" ");  
            else if(i==91||i==99)            System.out.print("S   ");
    ...
    void even(){        
        for(int n=i+1;n<=i+10;n++){              
            ...
            else if(n==49||n==24)            System.out.print("S   ");
            else if(n==45|n==22)            System.out.print("L   ");
            else            System.out.print(n+"  "); 
        }        
    }
    void odd(){
        for(int n=i+10;n>=i+1;n--){           
            if(n%10==1)            System.out.println(n+"   ");
            else if(n==14)            System.out.print("L   ");
            else if(n==72||n==57)            System.out.print("S   ");
            else            System.out.print(n+"  ");
        }
    } 
    int checkSorL(int x){
    ...
    void playGame(){
        try{
            ...
            if(count1==100)            System.out.println(p1+" won the game.");
            else if(count2==100)       System.out.println(p2+" won the game.");
