...
class Cricket {
    ...
    int getScore() {
        switch (diff) {
        case 'E':
            return 10 + ((int) (Math.random() * 10) * overs);
        case 'M':
            return 20 + ((int) (Math.random() * 15) * overs);
        case 'H':
            return 30 + ((int) (Math.random() * 20) * overs);
        }
        return -1;
    }
    ...
    void singlePlay() {
        try {
            ...
            if (mode == 'C') {
                if (runs >= target)
                    System.out.println("You have won by " + (10 - wickets) + " wickets.");
                else if (wickets == 10 || n > overs)
                    System.out.println("You have lost by " + (target - runs) + " runs.");
                ...
                if (oppScore < runs)
                    System.out.println("You have won by: " + (runs - oppScore) + " runs.");
                else if (oppScore >= runs)
